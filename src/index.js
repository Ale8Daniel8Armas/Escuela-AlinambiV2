...
import FormularioMatriculaPage from "views/secciones/admisiones/FormularioMatriculaPage.js";
...
root.render(
  <BrowserRouter>
    <Routes>
      ...
      <Route path="/formulario-matricula" element={<FormularioMatriculaPage />} />
      {/* Rutas del dashboard */}
